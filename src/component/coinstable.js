...
const CoinsTable = ({ coins }) => {
  ...
  return (
    <TrAnimation className="hoverT">
      ...
      <TdColor porsen={coins.price_change_percentage_1h_in_currency}>
        {coins.price_change_percentage_1h_in_currency?.toFixed(2)}%
      </TdColor>
      <TdColor porsen={coins.price_change_percentage_24h}>
        {coins.price_change_percentage_24h?.toFixed(2)}%
      </TdColor>
      <TdColor porsen={coins.price_change_percentage_7d_in_currency}>
